...
## Purpose
A CI workflow builds the demo site with Zola and deploys it to GitHub Pages on pushes to the default
branch, runnable manually via `workflow_dispatch`, providing a live demo and a build-time smoke test.
